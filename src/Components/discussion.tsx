...
const Discussion = ({
  ...
  return (
    <div className="w-[700px] flex space-x-2 mx-auto px-2 py-3 bg-white border border-gray-100 ">
      <div className="flex space-y-3 flex-col px-2 py-2 items-center justify-center">
        <img
          ...
          <div className="flex items-center space-x-5">
            ...
            >
              <svg
                ...
                stroke="gray"
                className={`w-5 h-5 ${
                  iLikedIt ? "fill-white" : "fill-gray-500"
                } `}
              >
                <path
                  strokeLinecap="round"
              ...
              <p className="text-gray-600 font-bold ">{likes}</p>
            </button>
            <button className="font-bold text-sky-500">Reply</button>
          </div>
        </div>
